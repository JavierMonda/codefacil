                    ...
                    <form action="{{ route('role.update', $role->id)}}" method="POST">
                       ...
                       @method('PUT')
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="description" id="description" placeholder="Descripción" rows="3" readonly>{{old('description', $role->description)}}</textarea>
                            </div>
                            ...
                            <a class="btn btn-danger" href="{{route('role.edit',$role->id)}}">Volver</a>
